...
class spdahi extends StatefulWidget{
  @override
  State<spdahi> createState() => _spdahiState();
}
class _spdahiState extends State<spdahi> {
  int _count =1;
  int _m=60;
  int _n =60;
  void _increment(){
        ...
        body: Stack(
          children: [
            Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Special Dahi Pani puri',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                            ...
                            Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      child: Text(' 3.2',style: TextStyle(fontSize: 15,color: Colors.white)),
                                    ),
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('285 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          margin: EdgeInsets.only(top: 20.0),
                                          child: Text('3.2',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                          margin: EdgeInsets.only(top: 5.0),
               ...
               - Potato
               - Pomegranate
               - Dahi''',style: TextStyle(color: Colors.white,fontSize: 18),),
                                  ),
                                ],
                              ),
                            ),
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 150,
      image: AssetImage('ast/img/pp5.png'),fit: BoxFit.cover
  );
}