...
class newyorkpizza extends StatefulWidget{
  @override
  State<newyorkpizza> createState() => _newyorkpizzaState();
}
class _newyorkpizzaState extends State<newyorkpizza> {
        ...
        body: Stack(
          children: [
            Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('New-york Style Pizza',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('594 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          margin: EdgeInsets.only(top: 20.0),
                                          child: Text('700g.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                          margin: EdgeInsets.only(top: 5.0),
               ...
               - Mozzarella
               - Basil
               - Red Paper Flex''',style: TextStyle(color: Colors.white,fontSize: 18),),
                                  ),
                                ],
                              ),
                            ),
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => CircleAvatar(
    ...
    backgroundImage: AssetImage('ast/img/p6.png'),
  );
