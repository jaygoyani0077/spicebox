        ...
        body: Stack(
          children: [
            Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Ham Burger',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('602 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
               ...
               - Tomato
               - onion
               - Lettuce''',style: TextStyle(color: Colors.white,fontSize: 18),),
                                  ),
                                ],
                              ),
                            ),
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 120,
      image: AssetImage('ast/img/b2.png'),fit: BoxFit.cover
  );
