...
class cheesemomos extends StatefulWidget{
  @override
  State<cheesemomos> createState() => _cheesemomosState();
}
class _cheesemomosState extends State<cheesemomos> {
  int _count =1;
  int _m=95;
  int _n =95;
  void _increment(){
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Cheese Momos',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/m5.png'),fit: BoxFit.cover
  );
