...
class tandoorimomos extends StatefulWidget{
  @override
  State<tandoorimomos> createState() => _tandoorimomosState();
}
class _tandoorimomosState extends State<tandoorimomos> {
  int _count =1;
  int _m=90;
  int _n =90;
  void _increment(){
        ...
        body: Stack(
          children: [
            Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Tandoori Momos',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      child: Text('  81%',style: TextStyle(fontSize: 15,color: Colors.white)),
                                    ),
                                    Container(
                            ...
                            Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      child: Text(' 4.5',style: TextStyle(fontSize: 15,color: Colors.white)),
                                    ),
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('426 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          margin: EdgeInsets.only(top: 20.0),
                                          child: Text('300g.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                          margin: EdgeInsets.only(top: 5.0),
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          margin: EdgeInsets.only(top: 20.0),
                                          child: Text('4.5',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                          margin: EdgeInsets.only(top: 5.0),
               ...
               - Potato
               - Coriander
               - Onion''',style: TextStyle(color: Colors.white,fontSize: 18),),
                                  ),
                                ],
                              ),
                            ),
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/m1.png'),fit: BoxFit.cover
  );
