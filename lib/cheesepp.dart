...
class cheesepp extends StatefulWidget{
  @override
  State<cheesepp> createState() => _cheeseppState();
}
class _cheeseppState extends State<cheesepp> {
  int _count =1;
  int _m=60;
  int _n =60;
  void _increment(){
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Cheese Pani puri',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('281 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/pp1.png'),fit: BoxFit.cover
  );
}