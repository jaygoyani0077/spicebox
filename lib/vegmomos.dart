...
class vegmomos extends StatefulWidget{
  @override
  State<vegmomos> createState() => _vegmomosState();
}
class _vegmomosState extends State<vegmomos> {
  int _count =1;
  int _m=50;
  int _n =50;
  void _increment(){
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Special Veg. Momos',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/m2.png'),fit: BoxFit.cover
  );
