...
class dahipp extends StatefulWidget{
  @override
  State<dahipp> createState() => _dahippState();
}
class _dahippState extends State<dahipp> {
  int _count =1;
  int _m=60;
  int _n =60;
  void _increment(){
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Dahi Paneer Pani puri',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('268 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/pp4.png'),fit: BoxFit.cover
  );
