...
class spicepaneer extends StatefulWidget{
  @override
  State<spicepaneer> createState() => _spicepaneerState();
}
class _spicepaneerState extends State<spicepaneer> {
  int _count =1;
  int _m=100;
  int _n =100;
  void _increment(){
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Spice Paneer Burger',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/b5.png'),fit: BoxFit.cover
  );
