...
class chikentikka extends StatefulWidget{
  @override
  State<chikentikka> createState() => _chikentikkaState();
}
class _chikentikkaState extends State<chikentikka> {
  int _count =1;
  int _m=100;
  int _n =100;
  void _increment(){
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Chikan Tikka Sandwich',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('573 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/s3.png'),fit: BoxFit.cover
  );
