...
class pudinapp extends StatefulWidget{
  @override
  State<pudinapp> createState() => _pudinappState();
}
class _pudinappState extends State<pudinapp> {
  int _count =1;
  int _m=60;
  int _n =60;
  void _increment(){
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Pudina Pani puri',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                            ...
                            Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      child: Text(' 3.7',style: TextStyle(fontSize: 15,color: Colors.white)),
                                    ),
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('258 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          margin: EdgeInsets.only(top: 20.0),
                                          child: Text('3.7',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                          margin: EdgeInsets.only(top: 5.0),
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/pp3.png'),fit: BoxFit.cover
  );
}