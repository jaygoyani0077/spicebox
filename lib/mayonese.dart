...
class mayonese extends StatefulWidget{
  @override
  State<mayonese> createState() => _mayoneseState();
}
class _mayoneseState extends State<mayonese> {
  int _count =1;
  int _m=85;
  int _n =85;
  void _increment(){
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Mayonnaise Sandwich',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/s4.png'),fit: BoxFit.cover
  );
