...
class chocolatemomos extends StatefulWidget{
  @override
  State<chocolatemomos> createState() => _chocolatemomosState();
}
class _chocolatemomosState extends State<chocolatemomos> {
  int _count =1;
  int _m=120;
  int _n =120;
  void _increment(){
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Chocolate Momos',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('486 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/m3.png'),fit: BoxFit.cover
  );
