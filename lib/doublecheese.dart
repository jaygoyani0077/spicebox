...
class doublecheese extends StatefulWidget{
  @override
  State<doublecheese> createState() => _doublecheeseState();
}
class _doublecheeseState extends State<doublecheese> {
  int _count =1;
  int _m=90;
  int _n =90;
  void _increment(){
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Double-cheese Burger',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('650 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/b3.png'),fit: BoxFit.cover
  );
