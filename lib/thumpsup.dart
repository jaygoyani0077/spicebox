...
class thumpsup extends StatefulWidget{
  @override
  State<thumpsup> createState() => _thumpsupState();
}
class _thumpsupState extends State<thumpsup> {
  int _count =1;
  int _m=40;
  int _n =40;
  void _increment(){
        ...
        body: Stack(
          children: [
            Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Thumps up',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      child: Text('  93%',style: TextStyle(fontSize: 15,color: Colors.white)),
                                    ),
                                    Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('100 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          margin: EdgeInsets.only(top: 20.0),
                                          child: Text('300ml.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                          margin: EdgeInsets.only(top: 5.0),
               ...
               - Thumps Up Syrup
               - Water
               - Sugar''',style: TextStyle(color: Colors.white,fontSize: 18),),
                                  ),
                                ],
                              ),
                            ),
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 150,
      image: AssetImage('ast/img/c3.png'),fit: BoxFit.cover
  );
