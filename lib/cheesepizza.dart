...
import 'package:spice_box/bill.dart';
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Cheese Pizza',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('699 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => CircleAvatar(
    ...
    backgroundImage: AssetImage('ast/img/p3.png'),
  );
