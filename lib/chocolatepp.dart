...
class chocolatepp extends StatefulWidget{
  @override
  State<chocolatepp> createState() => _chocolateppState();
}
class _chocolateppState extends State<chocolatepp> {
  int _count =1;
  int _m=60;
  int _n =60;
  void _increment(){
        ...
        body: Stack(
          children: [
            Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Chocolate Pani puri',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      child: Text('  95%',style: TextStyle(fontSize: 15,color: Colors.white)),
                                    ),
                                    Container(
                            ...
                            Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Container(
                                      child: Text(' 4.2',style: TextStyle(fontSize: 15,color: Colors.white)),
                                    ),
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('251 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          margin: EdgeInsets.only(top: 20.0),
                                          child: Text('10pcs.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                          margin: EdgeInsets.only(top: 5.0),
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          margin: EdgeInsets.only(top: 20.0),
                                          child: Text('4.2',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                          margin: EdgeInsets.only(top: 5.0),
               ...
               - Chocolate
               - Potato
               - Pomegranate''',style: TextStyle(color: Colors.white,fontSize: 18),),
                                  ),
                                ],
                              ),
                            ),
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/pp2.png'),fit: BoxFit.cover
  );
