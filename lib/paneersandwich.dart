...
class paneersandwich extends StatefulWidget{
  @override
  State<paneersandwich> createState() => _paneersandwichState();
}
class _paneersandwichState extends State<paneersandwich> {
  int _count =1;
  int _m=90;
  int _n =90;
  void _increment(){
        ...
        body: Stack(
          children: [
            Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text('Paneer Sandwich',style: TextStyle(fontSize: 22,color: Colors.white)),
                            ),
                            Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          ...
                                          child: Text('518 Kkal.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          margin: EdgeInsets.only(top: 20.0),
                                          child: Text('510g.',style: TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold),),
                                        ),
                                        Container(
                                          margin: EdgeInsets.only(top: 5.0),
               ...
               - Paneer
               - Tomato
               - Potato Slice''',style: TextStyle(color: Colors.white,fontSize: 18),),
                                  ),
                                ],
                              ),
                            ),
...
complain please report us.''',style: TextStyle(color: Colors.white,fontSize: 15),)
  ...
  buildfoodpic() => Image(
      height: 130,
      image: AssetImage('ast/img/s5.png'),fit: BoxFit.cover
  );
